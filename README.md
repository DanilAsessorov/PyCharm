...
##                                             ***ЗАДАНИЕ СЕДЬМОЕ - csv и pandas***
1. Создан отдельный модуль для новых функций **transaction.py**. Реализованы функция для считывания финансовых операций из CSV
...
2. Созданы тесты к новым функциональностям проекта, модуль **test_transaction.py**.
